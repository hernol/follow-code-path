    ...
    steps: [
      {
        ...
        whySpine: "Process entry for this feature.",
        stepOver: "s2",
        next: ["s2"],
      },
      {
        ...
        role: "spine",
        kind: "effect",
        note: "Replace with the next spine hop; add detail hops only for step-into.",
        whySpine: "Next process-relevant hop (or terminal effect).",
        stepOut: "s1",
      },
    ],
  };
